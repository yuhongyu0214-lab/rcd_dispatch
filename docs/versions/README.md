...
> 版本戳：`RCD-DOC-REGISTRY-20260903-R57`
> 建立日期：2026-07-13
> 治理更新时间：2026-09-03
...
| 项目当前状态 | 2026-09-03 / R57 | 新远端 `4d370d6…` 的 G4-4 主控裁决 PASS；三个旧 RC 拒绝；G4-5 入口就绪，T0 与执行尚未授权 | [状态总览](../status/README.md) |
| Agent 公共上下文 | RCD-AGENT-CONTEXT-20260903-R57 | Layer 0；区分代码/文档/镜像/运行身份，导航到 G4-5 分阶段联调方案，不复用旧授权 | [Agent 公共上下文](../context/agent-common-context.md) |
...
3A/3B 保持 `PASS / WARN`，只作为历史入口证据。Gate 4 位于 `feature/v2-stabilization`、`.worktrees/v2-stabilization`；代码/RC tag/OCI revision 均为 `4d370d664c3710a4a03cb1b665cfdeddc7d32778`，应用 tree `5188c0efcb96d646a9609b7c47dd624d578841ee`。已完成远端 RC 验收的文档基线及本地 origin 跟踪为 `7b6a2f472fe089b0a3dddf136b6f71f3b4a7e4f6`，本轮不重新联网或推送。主控已裁决 G4-4 `PASS`；新 index `sha256:508dea2dfa25da76581adc89b33d2ccf73eb91a21af26fa8f54e08fd94fe453d` 的完整身份链、双库/秘密扫描和证据清单见状态总览。G4-5 为 `ENTRY_READY / T0_NOT_STARTED / EXECUTION_AUTHORIZATION_PENDING`，不是部署完成。
...
3A/3B、已结束的返修/扫描和旧 G4-5 授权均不继承。三个旧 RC `4102ee1… / a0c8bbd… / 857705e…` 继续 `REJECTED_DO_NOT_DEPLOY`，不得覆盖、删除或部署。本轮仅批准同步并本地提交 5 份治理文档，不推送；正式 R57 文档 SHA 由主控提交回执下发，代码锚点仍为 `4d370d6…`，develop 仍为 `4102ee1…`。G4-5 方案、角色上下文和逐阶段授权见[主计划 §8.4.3](../superpowers/specs/2026-07-13-prd-v2-parallel-development-design.md#843-g4-5-预生产继续联调方案待执行授权)。
...
5. Gate 4 从 `4102ee1…` 启动，G4-1～G4-3 保持通过；历史 G4-5 SQL CRLF 阻断及三个拒绝 RC 保留。2026-09-03 新远端 `4d370d6…` 身份链、19/19 SQL、813/7、31/31 build、双库 Critical/High=0、秘密扫描 0 和独立审计均已通过，主控裁决 G4-4 `PASS`。本轮 R57 五文档提交后，依据 §8.4.3 另行授权新 G4-5 T0；资源/备份/回退/权限重新确认后再分别授权准备、migration、app、单 worker、Nginx 和真实联调。当前不执行部署、不合并 develop、不进入 main。
