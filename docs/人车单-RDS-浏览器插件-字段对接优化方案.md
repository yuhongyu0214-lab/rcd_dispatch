...
> **V1/过渡期来源材料，不是 V2 权威（2026-08-01）**：本文只用于追溯浏览器插件
> 的原始字段来源和维护现有兼容链路，不得定义 V2 数据模型、HTTP 契约、调度状态或
> 基础设施。V2 当前口径只认 `docs/versions/v2.0/data-architecture-v2.md`、
> `docs/versions/v2.0/api-contract-v2.md` 与 `docs/versions/v2.0/prd-v2.md`。
